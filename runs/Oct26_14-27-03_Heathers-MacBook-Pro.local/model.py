...
def batch_evaluate_classical_gat_models():
    ...
    for dataset_name, validation_dataset in validation_datasets.items():
        ...
        for model_file in model_files:
            ...
            try:
                ...
                if dataset_name == 'orign':
                    filename = f"./results/val_GAT_2018_epoch{epoch}.npz"
                else:
                    filename = f"./results/val_GAT_2018_epoch{epoch}_{dataset_name}.npz"
        ...
        # 7. 保存该数据集的汇总结果
        summary_file = f"./results/summary_GAT_2018_{dataset_name}.npz"
        np.savez(
            summary_file,
